...
export default function ServiceCard({ serviceInfo, index }) {
	const { image, title, description, slug } = serviceInfo || {};
		...
		>
			<div className="md:basis-1/2 relative overflow-hidden aspect-auto rounded-2xl sm:rounded-3xl border-2 border-neutral-bright-100/50 p-6 sm:p-8 md:p-6 lg:p-10 group">
				...
				<Image
					...
					sizes="auto"
					quality={100}
					className="relative object-cover aspect-[1.54/1] rounded-xl group-hover:scale-105 transition-transform duration-300"
				/>
			</div>
